...
import LeftBottomBox from "@/components/tokenomics/leftBottomBox";
  ...
  return (
    <Layout>
      ...
      >
        ...
        >
          <LeftTopBox
            headingText={t("tokenomics.leftTopBox.heading")}
            buttonText={t("tokenomics.leftTopBox.button")}
            mainnetText={t("tokenomics.leftTopBox.mainnet")}
            stackingRewardText={t("tokenomics.leftTopBox.stackingReward")}
          />
          {!matchesSM && (
            <>
              <LeftBottomBox />
