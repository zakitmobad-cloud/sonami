...
import LeftBottomBox from "@/components/utility/leftBottomBox";
  ...
  return (
    <Layout>
      ...
      >
        ...
        >
          <LeftTopBox
            headingText={t("utility.leftTopBox.heading")}
            buttonText={t("utility.leftTopBox.button")}
            mainnetText={t("utility.leftTopBox.mainnet")}
            stackingRewardText={t("utility.leftTopBox.stackingReward")}
          />
          {!matchesSM && (
            <>
              <LeftBottomBox />
